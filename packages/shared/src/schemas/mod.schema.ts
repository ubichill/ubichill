...
//
// 設計:
// - 1 つの Mod は複数の Component を配布できる
// - Component 名は `modId:componentName` 形式で参照される
 ...
 * build-workers.mjs が読み、`packages/frontend/public/mods/<name>/v<ver>/manifest.json` を生成する。
 */

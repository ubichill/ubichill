        ...
        return (
            <main className={containerStyle}>
                <div className={cardStyle}>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); handleVerifyOTP(); }} className={formStyle}>
        ...
        <main className={containerStyle}>
            <div className={cardStyle}>
                ...
                <form onSubmit={handleSubmit} className={formStyle}>
                    ...
                    <button type="submit" className={buttonStyle} disabled={isLoading || (mode === 'register' && isCheckingUsername)}>

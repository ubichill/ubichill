                ...
                >
                  <input
                    ...
                    className={css({
                      ...
                      border: "1.5px solid",
                      borderColor:
                        importState === "error" ? "errorText" : "border",
              ...
              >
                ...
                >
                  ...
                  <div className={css({ minW: 0 })}>
                    ...
                    >
                      <span>
                        {selectedWorld.capacity.default}〜
                        {selectedWorld.capacity.max}人
                      </span>
                    ...
                    >
                      ...
                      {session &&
                        selectedWorld?.authorId === session.user.id && (
                          <button
                            type="button"
                            onClick={() =>
                              navigate(`/world/${selectedWorld.id}/edit`)
                            }
                            className={css({
                              padding: "10px 16px",
